...
#
#         # 注册处理函数
#         self._configuration_handlers = {
#             ConfigurationModel: self._set_configuration,
#             ActionItemModel: self._set_configuration_from_items,
#             TrimActionItemModel: self._set_configuration_from_items_Trim,
#         }
#
...
#         elif all(isinstance(item, ActionItemModel) for item in config_items):
#             self._set_configuration_from_items(config_items)
#         elif all(isinstance(item, TrimActionItemModel) for item in config_items):
#             self._set_configuration_from_items_Trim(config_items)
#
